...
<div class="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
    <div class="text-start px-6">
        <h2 class="text-gray-800 text-3xl font-extrabold">Book an appointment</h2>
            ...
            <form>
                <div class="grid sm:grid-cols-2 gap-8">
                    <div class="relative flex items-center">
                        <input type="time" class="px-4 py-3 bg-[#f0f1f2] text-black w-full text-sm outline-[#007bff] rounded" />
                    ...
                    <div class="relative flex items-center">
                        <input type="date" class="px-4 py-3 bg-[#f0f1f2] text-black w-full text-sm outline-[#007bff] rounded" />
                    ...
                    <div class="relative flex items-center">
                        <input type="number" placeholder="Pregnancy Month"
                    ...
                    <div class="relative flex items-center">
                        <input type="dropdown" placeholder="Preffered Doctor Gender"
                            class="px-2 py-3 bg-white text-black w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none" />
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-2"
...
<div class="font-[sans-serif] px-4 py-8 bg-gradient-to-t from-green-50 to-purple-50">
    <div class="lg:max-w-5xl sm:max-w-2xl mx-auto">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-gray-800 text-3xl font-extrabold">Creative Team Section</h2>
        </div>

        <div class="grid lg:grid-cols-3 sm:grid-cols-2 gap-8 max-sm:gap-12 max-md:justify-center mt-16">

            <div class="flex items-center">
                <img src="https://readymadeui.com/team-1.webp" class="w-24 h-24 rounded-full" />
                <div class="ml-6">
                    <h4 class="text-gray-800 text-base font-bold">John Doe</h4>
                    <p class="text-xs text-blue-600 mt-1">Software Engineer</p>
                </div>
            </div>

            <div class="flex items-center">
                <img src="https://readymadeui.com/team-2.webp" class="w-24 h-24 rounded-full" />
                <div class="ml-6">
            ...
            <div class="flex items-center">
                <img src="https://readymadeui.com/team-3.webp" class="w-24 h-24 rounded-full" />
                <div class="ml-6">
            ...
            <div class="flex items-center">
                <img src="https://readymadeui.com/team-4.webp" class="w-24 h-24 rounded-full" />
                <div class="ml-6">
            ...
            <div class="flex items-center">
                <img src="https://readymadeui.com/team-5.webp" class="w-24 h-24 rounded-full" />
                <div class="ml-6">
                    <h4 class="text-gray-800 text-base font-bold">Alen</h4>
                    <p class="text-xs text-blue-600 mt-1">Software Developer</p>
                </div>
            </div>

            <div class="flex items-center">
                <img src="https://readymadeui.com/team-6.webp" class="w-24 h-24 rounded-full" />
                <div class="ml-6">
                    <h4 class="text-gray-800 text-base font-bold">Eleanor</h4>
                    <p class="text-xs text-blue-600 mt-1">Web Designer</p>
                </div>
            </div>
            ...
            <div class="flex items-center">
                <img src="https://readymadeui.com/team-2.webp" class="w-24 h-24 rounded-full" />
                <div class="ml-6">
                    <h4 class="text-gray-800 text-base font-bold">John</h4>
                    <p class="text-xs text-blue-600 mt-1">Web Designer</p>
                </div>
            </div>
            ...
            <div class="flex items-center">
                <img src="https://readymadeui.com/team-1.webp" class="w-24 h-24 rounded-full" />
                <div class="ml-6">
                    <h4 class="text-gray-800 text-base font-bold">Mark</h4>
                    <p class="text-xs text-blue-600 mt-1">Web Designer</p>
                </div>
            </div>
