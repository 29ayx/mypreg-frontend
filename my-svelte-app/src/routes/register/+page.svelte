    ...
    async function handleRegister() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          notification = data.message || "Registration failed!";
        }
      } catch (error) {
  ...
  <div class="font-[sans-serif] bg-white md:h-screen">
    <div class="grid md:grid-cols-2 items-center gap-8 h-full">
      ...
      <div class="flex items-center p-6 h-full w-full">
        <form class="max-w-lg w-full mx-auto" on:submit|preventDefault={handleRegister}>
          <div class="mb-12">
          ...
          <div>
            ...
            <div class="relative flex items-center">
              <input name="name" type="text" bind:value={firstname} required class="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Enter first name" />
          ...
          <div>
            ...
            <div class="relative flex items-center">
              <input name="name" type="text" bind:value={lastname} required class="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Enter last name" />
              <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-2" viewBox="0 0 24 24">
                <circle cx="10" cy="7" r="6"></circle>
                <path d="M14 15H6a5 5 0 0 0-5 5 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 5 5 0 0 0-5-5zm8-4h-2.59l.3-.29a1 1 0 0 0-1.42-1.42l-2 2a1 1 0 0 0 0 1.42l2 2a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42l-.3-.29H22a1 1 0 0 0 0-2z"></path>
              </svg>
          ...
          <div class="mt-6">
            ...
            <div class="relative flex items-center">
              <input name="email" type="email" bind:value={email} required class="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Enter email" />
          ...
          <div class="mt-6">
            ...
            <div class="relative flex items-center">
              <input name="password" type="password" bind:value={password} required class="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Enter password" />
          ...
          <div class="mt-6">
            ...
            <div class="relative">
              <button type="button" class="px-5 py-2.5 rounded text-white text-sm font-semibold border-none outline-none bg-blue-600 hover:bg-blue-700 active:bg-blue-600" on:click={toggleDropdown}>
                {role}
