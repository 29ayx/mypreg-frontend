...
import { onMount } from "svelte";
 ...
 let profileDatas = null;  // To store the profile data
    let notification = "";
    let profileData ="";
 ...
 async function fetchUsers() {
      ...
      try {
        ...
        if (response.ok) {
          profileDatas = data;
          profileData = profileDatas.length > 0;
...
<div class="font-[sans-serif] ml-[250px] max-w-full px-6 py-4 overflow-x-auto">
